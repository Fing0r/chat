...
const renderMessageOnScrollThrottle = (0, utils_1.throttle)(render_1.renderMessageOnScroll, 300);
const showArrowOnScrollThrottle = (0, utils_1.throttle)(utils_1.showArrowOnScroll, 200);
...
uiElements_1.CHAT.START.addEventListener("click", utils_1.scrollToBottom);
...
document.addEventListener("input", utils_1.hideAlert);
