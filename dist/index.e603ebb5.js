...
async function getCode(e) {
    e.preventDefault();
    try {
        const value = _helper.getValue(e);
        const modal = e.target.closest(".modal");
        const response = await _request.requestForCode(value);
...
function changeNameOldMessages() {
    [
        ..._config.MESSAGES.USER
    ].forEach((element)=>{
        const messageName = element.querySelector(".message__name");
        messageName.textContent = _config.AUTHOR.NAME;
    });
}
async function changeName(e) {
    try {
        ...
        _helper.showMessage(e, "Вы сменили ник");
        _config.AUTHOR.NAME = name.trim();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6fitd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "showArrowOnScroll", ()=>showArrowOnScroll
);
parcelHelpers.export(exports, "setCookiesToken", ()=>setCookiesToken
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","js-cookie":"c8bBu","./uiElements":"bu0XR"}],"7c4ZJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "requestForCode", ()=>requestForCode
);
parcelHelpers.export(exports, "requestForChangeName", ()=>requestForChangeName
);
parcelHelpers.export(exports, "importMessage", ()=>importMessage
);
parcelHelpers.export(exports, "requestForAccountData", ()=>requestForAccountData
);
var _config = require("./config");
...
function requestForAccountData(token) {
    ...
    return fetch(_config.URL.CHANGE_NAME, options);
}

},{"./config":"4Wc5b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9k0mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderMessages", ()=>renderMessages
);
parcelHelpers.export(exports, "renderMessageOnScroll", ()=>renderMessageOnScroll
);
var _uiElements = require("./uiElements");
var _config = require("./config");
var _message = require("./message");
var _messageDefault = parcelHelpers.interopDefault(_message);
function renderMessages(messages, startMessage = _config.MESSAGES.START, countMessage = _config.MESSAGES.END) {
...
},{"./uiElements":"bu0XR","./config":"4Wc5b","./message":"lGCpb","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lGCpb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dateFns = require("date-fns");
var _config = require("./config");
class Message {
    constructor({ text , user: { email , name  } , createdAt: time , status ,  }){
        this.email = email;
        this.text = text;
        this.name = name;
    ...
    createItem() {
        ...
        const isAuthorUser = this.email === _config.AUTHOR.EMAIL;
        if (isAuthorUser) this.item.classList.add("message--user");
        if (this.status) this.item.classList.add("message--sent");
        this.itemAuthor.textContent = isAuthorUser ? _config.AUTHOR.NAME : this.name;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cxlpn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eIiZF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _message = require("./message");
var _messageDefault = parcelHelpers.interopDefault(_message);
...
function ConnectSocket() {
    ...
    this.checkClose = ()=>{
        this.socket.addEventListener("close", (e)=>{
            if (e.wasClean) console.log(`[close] Соединение закрыто чисто, код=${e.code} причина=${e.reason}`);
            else {
    ...
    this.init = (token)=>{
        this.socket = new WebSocket(`${_config.URL.SOCKET}${token}`);
        this.checkMessage();
        this.checkError();
        this.checkClose();
    };
...
},{"./message":"lGCpb","./uiElements":"bu0XR","./helper":"6fitd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config":"4Wc5b"}]},["4FPSs","dLvKp"], "dLvKp", "parcelRequirece08")
