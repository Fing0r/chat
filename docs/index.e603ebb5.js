...
})({"4FPSs":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "351a8dd7e603ebb5";
...
},{}],"dLvKp":[function(require,module,exports) {
...
_uiElements.UI_ELEMENTS.CONFIRMATION.addEventListener("submit", _view.getCode);
_uiElements.UI_ELEMENTS.FORM.addEventListener("submit", _view.sendMessage);
_uiElements.UI_ELEMENTS.LOGIN.addEventListener("submit", _view.saveToken);
_uiElements.UI_ELEMENTS.CHANGE_NAME.addEventListener("submit", _view.changeName);
_uiElements.UI_ELEMENTS.EXIT.addEventListener("click", _view.signOut);

},{"./uiElements":"bu0XR","./view":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./modal":"guy4I"}],"bu0XR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function sendMessage(e) {
    ...
    if (!value) return;
    const newMessage = new _messageDefault.default(value);
    const newMessageItem = newMessage.createItem();
    MESSAGES.push(newMessage);
    _uiElements.UI_ELEMENTS.MESSAGES.prepend(newMessageItem);
...
async function changeName(e) {
    ...
    try {
        await fetch(_config.URL.AUTORIZATION, options);
...
async function getAccountData(token) {
    ...
    const response = await fetch(_config.URL.CHANGE_NAME, options);
    if (!response.ok) throw new Error("Ошибка запроса");
    const result = await response.json();
    stateUIElements(result);
}
function stateUIElements({ name  }) {
    _config.AUTHOR.USER = name || "Я";
    _uiElements.UI_ELEMENTS.NAME.value = _config.AUTHOR.USER;
...
},{"./uiElements":"bu0XR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./message":"lGCpb","./modal":"guy4I","js-cookie":"c8bBu","./config":"4Wc5b"}],"lGCpb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Message {
    constructor(text, author, status, time){
        this.text = text;
        this.author = author || _config.AUTHOR.USER;
        this.status = status || "unread";
        this.time = time || _dateFns.getTime(new Date());
    }
    createObj() {
        return {
            text: this.text,
    ...
    createItem() {
        ...
        const isAuthorNotUser = this.author !== _config.AUTHOR.USER;
        ...
        this.itemTime.textContent = _dateFns.format(new Date(this.time), "HH:mm");
        return this.item;
    }
    scrollToBottom() {
...
},{"date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config":"4Wc5b"}],"9yHCA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("./_lib/formatDistance/index.js.js.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
var _indexJs1 = require("./_lib/formatLong/index.js.js.js");
var _indexJsDefault1 = parcelHelpers.interopDefault(_indexJs1);
var _indexJs2 = require("./_lib/formatRelative/index.js.js.js");
var _indexJsDefault2 = parcelHelpers.interopDefault(_indexJs2);
var _indexJs3 = require("./_lib/localize/index.js.js.js");
var _indexJsDefault3 = parcelHelpers.interopDefault(_indexJs3);
var _indexJs4 = require("./_lib/match/index.js.js.js");
var _indexJsDefault4 = parcelHelpers.interopDefault(_indexJs4);
/**
 * @type {Locale}
 * @category Locales
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1UhOp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"guy4I":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["4FPSs","dLvKp"], "dLvKp", "parcelRequirece08")

//# sourceMappingURL=index.e603ebb5.js.map
